...
import '/front/style🖌️🖌️🖌️/🖌️🪪themestyles.pcss'
...
import { showCookies, setCookies } from '/front/comps🦾🦾🦾/Cookies🍪/cookies.js'
...
const global = browserCheck(),
  url = new URL(window.location.href)

global.base = ''
global.first = 1
global.cookies = localStorage.getItem('martinon_cookies') ? parseInt(localStorage.getItem('martinon_cookies')) : -1
global.cookies = url.searchParams.has('cookies') ? -1 : global.cookies
